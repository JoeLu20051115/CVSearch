...
CLIP_SNAPSHOT = "/mnt/data3/data_xingrui/.cache/huggingface/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41"


class ClipScorer:
    def __init__(self, device: str | None = None, model_path: str = CLIP_SNAPSHOT):
        import torch
