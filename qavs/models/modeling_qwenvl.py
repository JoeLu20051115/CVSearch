...
from .utils import *
from .modeling_dispatch import finalize_token_logits, single_token_choice_ids
...
class ModelQwenVL:
    def __init__(self, model_path: str, device: str = "cuda:0", torch_dtype=torch.bfloat16, **kwargs) -> None:
        ...
        actual_attn_implementation = kwargs.get("attn_implementation", "flash_attention_2" if transformers.utils.is_flash_attn_2_available() else "sdpa")
        self.use_flash_attn = actual_attn_implementation == "flash_attention_2"
    ...
    @torch.inference_mode()
    def label_token_losses(self, image_pil, question, codes, searched_nodes: List[NodeA] = None):
